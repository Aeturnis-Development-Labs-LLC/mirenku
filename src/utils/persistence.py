...
class PersistenceManager:
    ...
    def save_window_state(self, geometry: str, filter_status: str = "All", 
                         sort_column: str = "title", sort_order: str = "ascending"):
    ...
    def export_to_csv(self, file_path: Path) -> bool:
        ...
        try:
            ...
            with open(file_path, 'w', newline='', encoding='utf-8') as f:
                fieldnames = [
                    'title', 'status', 'episodes_watched', 'total_episodes',
                    'score', 'notes', 'date_added', 'date_updated'
                ]
                ...
                for anime in anime_list:
                    writer.writerow({
                        ...
                        'date_updated': anime.date_updated.isoformat() if anime.date_updated else ''
                    })
    ...
    def import_from_csv(self, file_path: Path) -> tuple[int, int, List[str]]:
        ...
        try:
            ...
            return 0, 0, [f"CSV import error: {str(e)}"]
