...
class NotificationManager:
    ...
    def show(self, message: str, level: NotificationLevel = NotificationLevel.INFO, 
             duration: int = 3000, callback: Optional[Callable] = None):
        """Show a notification
...
class NotificationWindow:
    ...
    def __init__(self, parent: tk.Tk, message: str, level: NotificationLevel,
                 duration: int, callback: Optional[Callable], on_close: Callable):
        ...
        if record.levelno >= logging.WARNING:
            try:
                ...
                self.error_handler.notification_manager.show(
                    message,
                    level,
                    duration=4000 if level == NotificationLevel.WARNING else 5000
                )
            except:
