...
class MALService:
    ...
    def _make_request(self, endpoint: str, params: Optional[Dict] = None, 
                     cache_strategy: Optional[CacheStrategy] = None) -> Dict:
            ...
            try:
                ...
                if e.code == 429:
                    ...
                    if attempt < max_retries - 1:
                        logger.warning(f"Server error {e.code}, retrying in {retry_delay} seconds...")
    ...
    def get_seasonal_anime(self, year: Optional[int] = None, 
    ...
    def download_image(self, image_url: str, save_path: Path) -> bool:
        ...
        try:
            ...
            request = urllib.request.Request(
                image_url,
                headers={'User-Agent': 'AnimeTracker/0.2.0'}
            )
