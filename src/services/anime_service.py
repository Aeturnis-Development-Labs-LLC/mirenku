...
class AnimeService:
    ...
    def add_anime(
        ...
        **kwargs,
        ...
        try:
            ...
            return False, f"Failed to add anime: {e!s}", None
    ...
    def update_anime(self, anime_id: int, **updates) -> Tuple[bool, str]:
        ...
        try:
            ...
            return False, f"Failed to update anime: {e!s}"
    ...
    def delete_anime(self, anime_id: int) -> Tuple[bool, str]:
        ...
        try:
            ...
            return False, f"Failed to delete anime: {e!s}"
    ...
    def filter_anime(
        ...
        return self.repository.filter(
            status=status, min_score=min_score, max_score=max_score, search_term=search
        )
