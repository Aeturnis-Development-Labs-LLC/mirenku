...
class MALAPIv2Service:
    ...
    def get_user_animelist(self, status: Optional[MALStatus] = None, 
        ...
        params = f"?fields=list_status&limit={limit}&offset={offset}"
    ...
    def update_anime_list_status(self, anime_id: int, 
                                 ...
                                 finish_date: Optional[date] = None) -> bool:
    ...
    def add_anime_to_list(self, anime_id: int, 
                         status: MALStatus = MALStatus.PLAN_TO_WATCH) -> bool:
    ...
    def sync_anime_to_local(self, mal_id: int) -> Optional[Dict]:
        ...
        if 'main_picture' in details:
            image_url = details['main_picture'].get('large') or \
                       details['main_picture'].get('medium')
